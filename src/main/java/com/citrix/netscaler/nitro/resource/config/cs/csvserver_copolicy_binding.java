...
class csvserver_copolicy_binding_response extends base_response
{
	public csvserver_copolicy_binding[] csvserver_copolicy_binding;
}
/**
	* Binding class showing the copolicy that can be bound to csvserver.
	*/

public class csvserver_copolicy_binding extends base_resource
{
...
Note: Use this parameter only in case of Content Switching policy bind operations to a CS vserver.<br> Minimum length =  1
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		csvserver_copolicy_binding_response result = (csvserver_copolicy_binding_response) service.get_payload_formatter().string_to_resource(csvserver_copolicy_binding_response.class, response);
		...
		return result.csvserver_copolicy_binding;
	}
	...
	*/
	...
	public static base_response add(nitro_service client, csvserver_copolicy_binding resource) throws Exception {
		csvserver_copolicy_binding updateresource = new csvserver_copolicy_binding();
	...
	public static base_responses add(nitro_service client, csvserver_copolicy_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			csvserver_copolicy_binding updateresources[] = new csvserver_copolicy_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				updateresources[i] = new csvserver_copolicy_binding();
	...
	public static base_response delete(nitro_service client, csvserver_copolicy_binding resource) throws Exception {
		csvserver_copolicy_binding deleteresource = new csvserver_copolicy_binding();
	...
	public static base_responses delete(nitro_service client, csvserver_copolicy_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			csvserver_copolicy_binding deleteresources[] = new csvserver_copolicy_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				deleteresources[i] = new csvserver_copolicy_binding();
	...
	*/
	...
	/**
	* Use this API to fetch filtered set of csvserver_copolicy_binding resources.
	* filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
	*/
	public static csvserver_copolicy_binding[] get_filtered(nitro_service service, String name, String filter) throws Exception{
		csvserver_copolicy_binding obj = new csvserver_copolicy_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
		csvserver_copolicy_binding[] response = (csvserver_copolicy_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static csvserver_copolicy_binding[] get_filtered(nitro_service service, String name, filtervalue[] filter) throws Exception{
		csvserver_copolicy_binding obj = new csvserver_copolicy_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
	...
	/**
	* Use this API to count csvserver_copolicy_binding resources configued on NetScaler.
	*/
	public static long count(nitro_service service, String name) throws Exception{
		...
		csvserver_copolicy_binding response[] = (csvserver_copolicy_binding[]) obj.get_resources(service,option);
		if (response != null) {
	...
	/**
	* Use this API to count the filtered set of csvserver_copolicy_binding resources.
	* filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
	*/
