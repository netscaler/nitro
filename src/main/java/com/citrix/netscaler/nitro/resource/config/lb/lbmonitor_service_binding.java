...
public class lbmonitor_service_binding extends base_resource
{
	...
	*/
	...
	public static base_response add(nitro_service client, lbmonitor_service_binding resource) throws Exception {
		lbmonitor_service_binding updateresource = new lbmonitor_service_binding();
	...
	public static base_responses add(nitro_service client, lbmonitor_service_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			lbmonitor_service_binding updateresources[] = new lbmonitor_service_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				updateresources[i] = new lbmonitor_service_binding();
	...
	public static base_response delete(nitro_service client, lbmonitor_service_binding resource) throws Exception {
		lbmonitor_service_binding deleteresource = new lbmonitor_service_binding();
	...
	public static base_responses delete(nitro_service client, lbmonitor_service_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			lbmonitor_service_binding deleteresources[] = new lbmonitor_service_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				deleteresources[i] = new lbmonitor_service_binding();
