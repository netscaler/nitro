...
class spilloverpolicy_gslbvserver_binding_response extends base_response
{
	public spilloverpolicy_gslbvserver_binding[] spilloverpolicy_gslbvserver_binding;
}
/**
	* Binding class showing the gslbvserver that can be bound to spilloverpolicy.
	*/

public class spilloverpolicy_gslbvserver_binding extends base_resource
{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		spilloverpolicy_gslbvserver_binding_response result = (spilloverpolicy_gslbvserver_binding_response) service.get_payload_formatter().string_to_resource(spilloverpolicy_gslbvserver_binding_response.class, response);
	...
	*/
	public static spilloverpolicy_gslbvserver_binding[] get(nitro_service service, String name) throws Exception{
	...
	*/
	public static spilloverpolicy_gslbvserver_binding[] get_filtered(nitro_service service, String name, String filter) throws Exception{
		spilloverpolicy_gslbvserver_binding obj = new spilloverpolicy_gslbvserver_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
		spilloverpolicy_gslbvserver_binding[] response = (spilloverpolicy_gslbvserver_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static spilloverpolicy_gslbvserver_binding[] get_filtered(nitro_service service, String name, filtervalue[] filter) throws Exception{
		spilloverpolicy_gslbvserver_binding obj = new spilloverpolicy_gslbvserver_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, String name) throws Exception{
		...
		spilloverpolicy_gslbvserver_binding response[] = (spilloverpolicy_gslbvserver_binding[]) obj.get_resources(service,option);
		if (response != null) {
