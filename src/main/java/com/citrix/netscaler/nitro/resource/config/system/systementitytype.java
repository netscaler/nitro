...
class systementitytype_response extends base_response
{
	public systementitytype systementitytype;
}
/**
...
public class systementitytype extends base_resource
{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception {
		systementitytype[] resources = new systementitytype[1];
		systementitytype_response result = (systementitytype_response) service.get_payload_formatter().string_to_resource(systementitytype_response.class, response);
		...
		resources[0] = result.systementitytype;
		return resources;
	}
	...
	* Use this API to fetch all the systementitytype resources that are configured on netscaler.
	*/
	public static systementitytype get(nitro_service service,  options option) throws Exception{
		systementitytype obj = new systementitytype();
