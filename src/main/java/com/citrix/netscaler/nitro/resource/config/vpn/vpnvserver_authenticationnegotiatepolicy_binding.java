...
class vpnvserver_authenticationnegotiatepolicy_binding_response extends base_response
{
	public vpnvserver_authenticationnegotiatepolicy_binding[] vpnvserver_authenticationnegotiatepolicy_binding;
}
/**
	* Binding class showing the authenticationnegotiatepolicy that can be bound to vpnvserver.
	*/

public class vpnvserver_authenticationnegotiatepolicy_binding extends base_resource
{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		vpnvserver_authenticationnegotiatepolicy_binding_response result = (vpnvserver_authenticationnegotiatepolicy_binding_response) service.get_payload_formatter().string_to_resource(vpnvserver_authenticationnegotiatepolicy_binding_response.class, response);
	...
	*/
	public static vpnvserver_authenticationnegotiatepolicy_binding[] get_filtered(nitro_service service, String name, String filter) throws Exception{
		vpnvserver_authenticationnegotiatepolicy_binding obj = new vpnvserver_authenticationnegotiatepolicy_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
		vpnvserver_authenticationnegotiatepolicy_binding[] response = (vpnvserver_authenticationnegotiatepolicy_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static vpnvserver_authenticationnegotiatepolicy_binding[] get_filtered(nitro_service service, String name, filtervalue[] filter) throws Exception{
		vpnvserver_authenticationnegotiatepolicy_binding obj = new vpnvserver_authenticationnegotiatepolicy_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, String name) throws Exception{
		...
		vpnvserver_authenticationnegotiatepolicy_binding response[] = (vpnvserver_authenticationnegotiatepolicy_binding[]) obj.get_resources(service,option);
		if (response != null) {
