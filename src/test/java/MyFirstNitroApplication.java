...
public class MyFirstNitroApplication {
	...
	@Test
	public static void CRD_LbVserver() { // Create, Retreive, Delete LB Vserver
		
		try {
			System.out.println("UnitTesting using MyFirstNitroApplication");
			//Create an instance of the nitro_service class to connect to the appliance
			nitro_service ns_session = new nitro_service("10.102.31.109","HTTP");
